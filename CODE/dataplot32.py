...
listDailyaverages.to_csv('DaiyACE2016.csv')
listDailyaverages2.to_csv('DaiyJuno2016.csv')
...
ax[0].set_yticks(q)
ax[0] = ax[0].twinx()
ax[0].bar(np.arange(0,366, 1), sun1['Dailysunspotno'],  color = 'Blue')
...
ax[1].set_yticks(q)
ax[1] = ax[1].twinx()
ax[1].bar(np.arange(0,366, 1), sun2['Dailysunspotno'], color = 'Blue')
ax[1].set_yticks(np.arange(0., 200., 50.))

 
ax[2].plot(days6, value6) 
ax[2].set_ylabel('                                     $R^{2} B_{r}$ $(AU^{2}$ $nT)$', color = 'Red')
ax[2].set_xlabel('Day')
ax[2].legend(['2016'])
ax[2].set_yticks(q)
ax[2] = ax[2].twinx()
ax[2].set_ylabel('                                  Daily count', color = 'Blue')
ax[2].bar(np.arange(0,366, 1), sun3['Dailysunspotno'], color = 'Blue')
