...
plt.rc('axes', titlesize= 40, labelsize = 35)
...
lengthlimit = 2   #in hours, minimum length of sequence
Flucuations = 48
removal_length = 2
...
ax[0].set_ylabel('R^2 Br (AU^2 nT)', color = 'Red')
ax[0].set_title('ACE Postive Sector')
ax[0] = ax[0].twinx()
ax[0].set_ylabel('Daily Sunspot Number', color = 'Blue')
data.plot.bar(y = 'Dailysunspotno', ax =ax[0], color = 'Blue')
...
ax[1] = ax[1].twinx()
ax[1].set_xlabel('Day')
ax[1].set_ylabel('Daily Sunspot Number', color = 'Blue')
data.plot.bar(y = 'Dailysunspotno', ax =ax[1],color = 'Blue')
plt.sca(ax[1])
plt.xticks(np.arange(1, 366, 10))   
