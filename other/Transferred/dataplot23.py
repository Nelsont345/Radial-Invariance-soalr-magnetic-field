...
#%%Processing,  24 NaN values (from 366),  and missing extra 28 values  8724
...
plt.figure()       
reduceflucuations(listHourlyaverages['angle'])
reduceflucuations(listHourlyaverages2['angle'])
